...
<html lang="pt_br">
  <head>
    <title>Admin | Login Administrador
    </title>
    <meta charset="utf-8">
        ...
        <div class="row">
          ...
          <div style="margin-left: 50px;" class="col-md-12 appointment ftco-animate">
            ...
            <form action="" method="post" class="appointment-form">
              ...
              <div style="text-align: center;" class="form-gorup">
                 <a href="/cadastro_cliente.php">Cadastre-se caso não possua uma conta</a>
              </div>
            ...
            <?php
              ...
              if (isset($_POST['login'])){
                ...
                $select = "SELECT * FROM tb_cliente WHERE emailCliente=:emailLogin AND senhaCliente=:senhaLogin";
